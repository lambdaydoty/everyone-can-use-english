...
<span class="pho">s/z</span> 發聲時舌尖起始位置貼近但沒有接觸到牙齒和牙齦的接縫處 —— 即，位置 ②。
...
中文裡當然也有 <span class="pho">s</span> 這個音，但，中文裡的 <span class="pho">s</span> 在發音時舌尖起始位置更接近下排牙齒，即，比位置 ② 更低一些你可以再試著用中文普通話說一遍 “我踢死你！”（<span class="pho">wǒ tī sǐ nǐ</span>）<span class="speak-word-inline" data-audio-other="/audios/我踢死你-zh-cn-male.mp3"></span>…… 

雖然兩個略微不同的舌尖起始位置在單個音素中聽不出什麼區別。但，如果作為中國人不練出一個舌尖起始位置為 ② 的 <span class="pho">s</span><span class="speak-word-inline" data-audio-us-male="/audios/us_phonetics_sound_say_2023feb.mp3"></span>，那麼說英文就相當吃力…… 比如，在說 <span class="pho">st</span> 這個組合的時候 —— 而 <span class="pho">st</span> 這恰好也是英文中使用頻率特別高的一個組合。

## 3.2.5.3. 長子音

英文的子音原本並沒有長短區分 —— 有些語言的子音是有長短區分的 —— 亞洲語言也基本都沒有這種差別。

然而，英文的 <span class="pho">f/v</span>、<span class="pho">s/z</span>、<span class="pho">ʃ</span> 以及 <span class="pho">ts</span> 是可以拉長的，尤其是 <span class="pho">s</span> 和 <span class="pho">ts</span>。經過提醒之後，在自然語流中你經常會注意到這種情況。

## 3.2.5.4. <span class="pho">s</span> 之後的濁化

另外，需要注意的是，<span class="pho">s</span> 之後的 <span class="pho">p/t/tr/k</span> 作為音節開頭時會被濁化（比如，音節末尾的 <span class="pho">st</span> 中的 <span class="pho">t</span> 不會被濁化），相應讀成 <span class="pho">b/d/dr/g</span>（但是，音標標註卻保持原樣）：
...
## 3.2.5.5. 複數末尾的 <span class="pho">s</span> 和 <span class="pho">z</span>

英語的名次和動詞都有複數形式，末尾 <span class="pho">s</span> 與 <span class="pho">z</span> 的區分挺重要的，最好從一開始就能夠說對…… 時間拖得越久越難改。

* 清子音後讀作 <span class="pho">s</span>
  ...
  * 但，清子音 <span class="pho">t</span> 和 <span class="pho">s</span> 讀成 <span class="pho">ts</span>
...
* 濁子音後讀作 <span class="pho">z</span>
  ...
  * 但，清子音 <span class="pho">d</span> 和 <span class="pho">s</span> 讀成 <span class="pho">dz</span>
...
* <span class="pho">s</span>/<span class="pho">z</span>/<span class="pho">ʃ</span>/<span class="pho">tʃ</span>/<span class="pho">ʒ</span>/<span class="pho">dʒ</span> 結尾的詞加上 *es* 讀作 <span class="pho alt">ɪz</span>
