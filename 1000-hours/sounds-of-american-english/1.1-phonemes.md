...
在自然語流中，不可繼續分割的組成部分被稱為**音素**（*phonemes*）。

英語的音素分為**母音**（*vowels*）和**子音**（*consonants*）。**音標**（*phonetics*）是用來標記音素的符號系統 —— 每個音素都由一個獨特的音標符號標記。

我們採用的是《劍橋英語發聲詞典》（[Cambridge English Pronouncing Dictionary](https://dictionary.cambridge.org/pronunciation/), i.e. *CEPD*）的音標標註體系。

在《劍橋英語發聲詞典》裡，英式英語的音標採用 *D.J.* 音標，而美式英語的音標則採用國際音標（*IPA*）[^1]，並針對美式英語做了些 “最佳化”：

> * <span class="pho">ə</span> 的長短版本兒化音，分別是 <span class="pho">ɚ</span> 和 <span class="pho">ɝː</span>
> * <span class="pho">ə</span> 結尾的雙母音和三母音，結尾的 <span class="pho">ə</span> 使用 <span class="pho">r</span> 替換，比如 <span class="pho">ɪə</span>  ⭢ <span class="pho">ɪr</span>，或者 <span class="pho">aʊə</span>  ⭢ <span class="pho">aʊr</span>
> * 短母音 <span class="pho">ɒ</span> 用 <span class="pho">ɑː</span> 標註
> * <span class="pho">t</span> 增加了一個彈舌音版本 <span class="pho">t̬</span>

以下的羅列部分基於[《劍橋英語發聲詞典》](https://dictionary.cambridge.org/pronunciation/)的官方音標指南，在此基礎上做了一些補充並重新排序[^2]，並刻意減少了例詞的數量。

> [!Note]
> 《劍橋英語發聲詞典》官方音標指南（Pronunciation symbols）：
> > https://dictionary.cambridge.org/help/phonetics.html

雖然我們的教程著重講解的是 “**美式英語**” 語音，但，為了教學方便，也同時羅列了 “英式英語” 的音素和音標。
...
> [!Note]
>
> [《劍橋英語發聲詞典》官方音標指南](https://dictionary.cambridge.org/help/phonetics.html)中除了 <span class="pho">ɚ</span> 和 <span class="pho">ɝː</span> 之外，其它母音的美式英語兒化音都沒有羅列，比如，
...
> [!Note]
>
> [《劍橋英語發聲詞典》官方音標指南](https://dictionary.cambridge.org/help/phonetics.html)中沒有羅列 <span class="pho">tr</span> 和 <span class="pho">dr</span>。
...
| 符號                                                   | 含義                                                                        |
| ------------------------------------------------------ | --------------------------------------------------------------------------- |
| <span class="pho">ɤ</span>                             | 比 *schwa* <span class="pho">ə</span> 更輕的近乎於無的母音                  |
| <span class="pho">ʔ</span>                             | <span class="pho">t</span> 的喉塞音版本                                     |
| <span class="pho">ᵗ</span>/<span class="pho">◌̥</span>  | 可選 <span class="pho">t</span> 或者 <span class="pho">t̥</span>，即，不發聲 |
| <span class="pho">◌̚ </span>/<span class="pho">◌̥</span> | 清子音的阻塞音符號（可與 /<span class="pho">◌̥</span> 通用，都不發聲）         |
| <span class="pho">ᵊ</span>                             | 音節子音  <span class="pho">l, m, n, r</span> 之前的附帶母音                |
| <span class="pho">ʲ</span>                             | 音節之間的加音 <span class="pho">j</span>                                   |
| <span class="pho">ʷ</span>                             | 音節之間的加音 <span class="pho">w</span>                                   |
| <span class="pho">◌̅, ◌́, ◌̀</span>                       | 音節聲調，平、升、降                                                        |
| <span class="pho">◌̂</span>                             | 音高被抬高的音節                                                            |
| <span class="pho">·</span>                             | 音節之間的停頓（*stop*）                                                    |
| <span class="pho">◌‿◌</span>                           | 連讀符號                                                                    |
| <span class="pho">｜</span>                            | 單詞之間分割意群的暫停（*pause*）                                           |

> [!Note]
>
> 你可能注意到了，同一個基礎音素的變體，可能用了不同的寫法，比如， <span class="pho">ɑ</span> 這個基礎音素，短母音用的是 <span class="pho">ʌ</span>，長母音不是 <span class="pho">ʌː</span> 而是 <span class="pho">ɑː</span>，而後組合成雙母音的時候用的是 <span class="pho">a</span> —— <span class="pho">aɪ，aʊ</span> 等等……
>
> 這麼做的理由在於，當這些音素連在一起的時候，不可能被錯誤組合，不會產生混淆，所以要確保每個音素都有一個獨特對應的符號[^3]。

[^1]: 教程內音標字型選用的是 *Charis SIL*，https://software.sil.org/charis/
[^2]: 音素的語音檔案來自劍橋官方網站；例詞的語音檔案大部分使用 [Microsoft Edge TTS](https://github.com/rany2/edge-tts) 生成，聲音角色選擇分別是：*en-GB-ThomasNeural*，*en-GB-MaisieNeural*，*en-US-RogerNeural*，和 *en-US-JennyNeural*
[^3]: 現在幾乎所有詞典都聲稱自己採用國際音標（IPA），但它們無一例外，都是國際音標的一個 “**自定義子集**”。
